...
#include "ManeuveringMode.h"
// endregion
// endregion
// region Define
#define PRETTY_FILE_NAME "ModelDevelop/Aircraft/Aircraft"
#if defined(_WIN32) && !defined(StaticAircraft_Build)
#ifdef SharedAircraft_Build
...
class DLL_EXPORT_IMPORT AircraftModel {
// region USING/FRIEND
    private:
// endregion
...
// region Public Methods
    public:
         ...
         */
        void take_off(double theta_f_d, double psi_f_d);
...
// region Get/Set选择器
    public:
         ...
         * @return
         */
        [[nodiscard]] Eigen::Vector3d positionLaunchNUE() const {
        ...
        [[nodiscard]] Eigen::Vector3d w_xyz() const {
            return _imu_info.imu_w_xyz_body*57.3;
        }
         ...
         * @return
         */
        [[nodiscard]] Eigen::Vector3d targetPositionLaunchNUE() const {
     ...
     void setManeuvering(ManeuveringModeType _type,std::string para);
