...
#if defined(_WIN32) && !defined(StaticR11_Build)
#ifdef SharedR11_Build
...
// region Public Methods
    public:
         ...
         * @param clearQueue
         */
        void setTargetEcf(const Eigen::Vector3d &targetPosEcf, const Eigen::Vector3d &targetVelEcf,bool clearQueue=false);
         ...
         * @param clearQueue
         */
        void setTargetLLA(const Eigen::Vector3d &targetPosLLa, const Eigen::Vector3d &targetVelEcf,bool clearQueue=false);
...
// region Get/Set选择器
    public:
        ...
        [[nodiscard]]
        Eigen::Vector3d pBody() const {
            return _p_body;
        }

        [[nodiscard]]
        Eigen::Vector3d mBody() const {
            return _m_body;
        }
        ...
        */
        ...
        [[nodiscard]] bool terminalHoldMomentActive() const {
            return _terminalHoldMomentActive;
        }

        [[nodiscard]] bool terminalHoldInsideCone() const {
            return _terminalHoldInsideCone;
        }

        [[nodiscard]] double terminalHoldViewAngleDeg() const {
...
// region Private Attributes
    private:
         ...
         * @brief 关机点速度
         */
        Eigen::Vector3d _cutOffPointVelEcf{0,0,0};
        /*!
         * @brief 关机点位置
         */
        Eigen::Vector3d _cutOffPointPosEcf{0,0,0};
