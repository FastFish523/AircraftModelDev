...
// region Public Methods
    public:
         ...
         * @param P 推力牛
         * @param Mass 质量 千克
         * @param cutPosEcf 关机点位置
         * @param cutVelEcf 关机点速度
         ...
         * @return
         */
        GCInfo getGCInfo(double flyTime, double P, double Mass, const Eigen::Vector3d &cutPosEcf, const Eigen::Vector3d &cutVelEcf, const Eigen::Vector3d &targetPosEcf, const Eigen::Vector3d &targetVelEcf, const State &state, double maxLoad);
