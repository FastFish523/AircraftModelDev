...
// region Public Methods
    public:
         ...
         * @return 侧向加速度指令   巡航高度
         */
        std::pair<double, double> calculateL1Guidance(double maxLoad, const Eigen::Vector3d &currentPosEcf, const Eigen::Vector3d &currentVelEcf,const std::deque<Eigen::Vector3d> &waypoints, int &currentWpIndex);
        ...
        * @return 横向加速度（m/s²）
        */
        double calculateL1GuidanceNUE(const Eigen::Vector2d &pos_nue,const Eigen::Vector2d &vel_nue,const Eigen::Vector2d &wp_start,const Eigen::Vector2d &wp_end,double L1_distance = 100.0);
        /*!
         * @brief 兰伯特1
         * @param r_m 起始点ecf坐标
         * @param r_pip 落点ecf坐标
