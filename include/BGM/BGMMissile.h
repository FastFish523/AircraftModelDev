...
#if defined(_WIN32) && !defined(StaticBGM_Build)
#ifdef SharedBGM_Build
...
// region Public Methods
    public:
         ...
         * @param MH 目标速度（马赫）
         */
        void setCruiseAltAndMH(const double &alt, const double &MH);
        /*!
         * @brief 设置目标
...
// region Get/Set选择器
    public:
        void setGetLOSInfoFunction(GetLOSInfoFunction getLOSInfoFunction){
            _guidance.setGetLOSInfoFunction(getLOSInfoFunction);
        }
        /*!
         * 获取飞行时间 秒
         * @return
