...
#if defined(_WIN32) && !defined(StaticHACM_Build)
#ifdef SharedAGM86_Build
...
// region Public Methods
    public:
         ...
         * @param desired_vel 期望的巡航速度
         * @param desired_h 期望的巡航高度
         * @param launch_vel 发射速度
         */
        void launch(double theta_f_d, double psi_f_d, double desired_vel, double desired_h, double launch_vel);
        ...
        /*!
         * @brief 设置路径点，基于期望速度剔除不合理的路径点
         * @param routes
         * @param V 期望速度
         * @return
         */
        void setRoutePoints(const std::deque<Eigen::Vector3d> &routes,double V);
...
// region Private Attributes
    private:
        ...
        * @brief 发射速度
        */
        double _launch_vel = 0;
        /*!
         * @brief 期望巡航速度
         */
        double _desired_vel = 0;
        /*!
        * @brief 期望巡航速度
       */
        double _desired_h = 1000;
        /*!
         * @brief 仿真步长
         */
        double _step = 0.005;
