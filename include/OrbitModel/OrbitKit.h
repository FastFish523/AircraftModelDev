...
//Operations
    ...
    public:
        ...
        void AzimuthElevation(double *Azimuth, double *Elevation, double *Range, double SiteLat, double SiteLong,
                              double SiteAltitude, double SatLat, double SatLong, double SatRadius);

        void
        MapToOrbitCoord(double *x, double *y, double *z, double alphas, double deltas, double omig, double i, double u);
