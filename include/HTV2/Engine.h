...
#define HTV2_ENGINE_API __declspec(dllexport)
#else
#define HTV2_ENGINE_API __declspec(dllimport)
#endif
#else
#define HTV2_ENGINE_API
#endif
// endregion

namespace ModelDevelop::HTV2 {
    class HTV2_ENGINE_API Engine {
// region USING/FRIEND
    private:
// endregion
