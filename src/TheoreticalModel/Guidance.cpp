...
// endregion
// region Self
#include "TheoreticalModel/Guidance.h"
#include "TheoreticalModel/Seeker.h"
...
// region Static Attributes Init
    ...
    GCInfo Guidance::getGCInfo(const double flyTime, const double P, const double Mass, const Eigen::Vector3d &targetPosEcf, const Eigen::Vector3d &targetVelEcf,
        ...
        auto targetLla                   = ModelDevelop::Utils::CoordinateHelper::ecefToLla(targetPosEcf);
        ...
        else if (P > 0 && target_dis > 15000) //策略 比例中制导
        {
            ...
            acc_cmd_v.y()   =  9.8 + 2 * (targetLla.z() - lla.z()) - 2 * 4 * 0.25 * Vy;
        }
        else //末制导
        {
            // 制导指令
