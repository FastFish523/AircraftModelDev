...
// region Public Methods
    void FileSaver::save_traj(const Missile *missile) {
        fprintf(
            result_fp_traj(),
            "%.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f\n",
            missile->flyTime(),
            ...
            missile->mBody().y(),
            missile->mBody().z(),
            missile->terminalHoldPhaseActive() ? 1.0 : 0.0,
            missile->terminalHoldMomentActive() ? 1.0 : 0.0,
            missile->terminalHoldInsideCone() ? 1.0 : 0.0,
            missile->terminalHoldViewAngleDeg()
        );
    }
