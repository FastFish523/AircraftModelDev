...
#include "HTV2/TerminalAttitudeHold.h"
...
namespace ModelDevelop::HTV2 {
    ...
    bool TerminalAttitudeHold::holdInitialAttitude() const {
        return _config.holdInitialAttitude;
    }
    ...
    TerminalAttitudeHoldOutput TerminalAttitudeHold::update(
        ...
        output.attitudeCmd = attitudeCmd;
