...
// region Public Methods
    void FileSaver::save_traj(const Missile *missile) {
        fprintf(
            result_fp_traj(),
            "%.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %d %d\n",
            missile->flyTime(),
            ...
            missile->sigmaAzDot(),
            missile->phaseId(),
            missile->terminalHoldPhaseActive() ? 1 : 0
        );
    }
