...
// endregion
// region Self
#include "LRHW/Guidance.h"
#include "LRHW/Seeker.h"
#include "CoordinateHelper.h"
// endregion
// endregion

// region Define
#define PRETTY_FILE_NAME "ModelDevelop/LRHW/LRHW"
// endregion
...
// region Static Attributes Init
    ...
    GCInfo Guidance::getGCInfo(const double flyTime, const double P, const double Mass, const Eigen::Vector3d &targetPosEcf, const Eigen::Vector3d &targetVelEcf,
        ...
        double alpha=0;
        double beta = 0;
        Utils::CoordinateHelper::calculateAngleOfAttack(selfVel_nue,state.qbn,alpha,beta);
